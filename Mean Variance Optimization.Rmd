...
# return for perioden
total_return_min_var <- (cumprod(1+return_min_var/100)-1)*100
total_return_max_return <- (cumprod(1+return_max_return/100)-1)*100

total_return_min_var[k]/n
total_return_max_return[k]/n

sd(return_min_var)
sd(return_max_return)

total_return_df <- tibble(
  "Date" = factors_period$date,
  "Min_var" = total_return_min_var,
  "Max_return" = total_return_max_return
)
