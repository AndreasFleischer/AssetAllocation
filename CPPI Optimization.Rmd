...
for (j in 36:124){
  ...
  return(list("Guarantee_end" = Guarantees, "Floor" = Floor_month, "C" = C_month, "Wealth_month" = W_month, "E" = E_month, "Trigger_hit" = Trigger_hit, "Guarantee_month" = N_month))
}
```
